...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // Search the phone's hotspot for the Pi as soon as the app opens. If the Pi
    // hasn't joined yet this fails quietly and the status chip shows an error;
    // tapping the chip retries.
  ...
  Widget _stageCardFor(BuildContext context, int index) {
    ...
    return _StageCard(
      ...
      index: index,
      onTap: () {
        // Tell the Pi which exhibit was selected (no-op if not connected), then
        // open the audio-guide player.
  ...
  Widget _buildHeader(bool isCompact) {
    return Row(
      ...
      children: [
        ...
        // Live Raspberry Pi connection status — tap to search / retry.
