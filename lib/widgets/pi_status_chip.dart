...
/// A raised neumorphic chip that shows the live link state to the Raspberry Pi
/// and lets the visitor search/retry or disconnect with a tap.
///
...
class PiStatusChip extends StatelessWidget {
  ...
  void _onTap(BuildContext context, PiConnection pi) {
    if (pi.status == PiStatus.connected) {
      ...
      // Scan the hotspot for the Pi and connect.
      pi.discover();
    }
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Connected over your hotspot to ${pi.host}:${pi.port}',
